...
// I'm doubting this supports windoge
...
namespace Alice {
	...
	namespace TermColors {
		...
		// stop terminal effects and colors
		...
		// I think it should be compatible with big and little endian machines but
		// I have not tested it on a little endian processor. Middle endian is not
		// supported.
		typedef struct RGB_t { // 24bit color.
				union {
